...
public sealed class LoginViewModel : ViewModelBase
{
    ...
    public LoginViewModel(AuthService auth, NavigationStore nav, IServiceProvider sp, WebSocketService ws, ApiService api, UserStore userStore)
    {
        _auth = auth;
        _nav = nav;
        _sp = sp;
        ...
        GoRegisterCommand = new RelayCommand(async (_) =>
        {
            _nav.CurrentViewModel = (ViewModelBase)_sp.GetService(typeof(RegisterViewModel))!;
        });
    }
